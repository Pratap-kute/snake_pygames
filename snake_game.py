...
class SNAKE:
    ...
    def draw_snake(self):
        ...
        for index, block in enumerate(self.body):
            ...
            # what direction is the face of the snake
            if index == 0:
                # create the rectangle for the head
                # draw the rectangle
                # pygame.draw.rect(screen, (183, 111, 122), snake_rect)
                ...
                # this block is a corner
                else:
                    # if the previous block is going up and the next block is going left
                    if (
                        previous_block.x == -1
                        and next_block.y == -1
    ...
    def update_head_graphics(self):
        """Update the head of the snake based on the direction it is moving"""
    ...
    def update_tail_graphics(self):
        """Update the tail of the snake based on the direction it is moving"""
...
class MAIN:
    ...
    # check if the snake is outside the screen or if it hits itself
    def check_fail(self):
